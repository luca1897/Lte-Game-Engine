...
namespace scene
{
	enum E_ANIMATED_MESH_TYPE
	{
		...
		//! format of the engine Engine.
		EAMT_X,

		//! My3D Mesh, the file format by Zhuck Dimitry
		EAMT_MY3D,

		//! Pulsar LMTools (.lmts) file. The engine loader for this was written by
		//! Jonas Petersen
		EAMT_LMTS,
	...
	You might want to use engine::scene::SAnimatedMesh, engine::scene::SMesh, 
	engine::scene::SMeshBuffer etc. */
