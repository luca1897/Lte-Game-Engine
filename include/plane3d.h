...
#ifndef __engine_PLANE_3D_H_INCLUDED__
#define __engine_PLANE_3D_H_INCLUDED__
...
class plane3d
{
	public:
		...
		{
			f32 fn00 = Normal.getLength();
			f32 fn01 = Normal.dotProduct(other.Normal);
			f32 fn11 = other.Normal.getLength();
			f32 det = fn00*fn11 - fn01*fn01;

			if (fabs(det) < 1e-08f)
				return false;

            det = 1.0 / det;
			f32 fc0 = (fn11*-D + fn01*other.D) * det;
			f32 fc1 = (fn00*-other.D + fn01*D) * det;
