...
public:
	...
	//! \param newDirectory: path to the directory to be created
	//! \return Returns true if directory was created, false on error
	virtual bool makeDirectory(const c8* newDirectory) = 0;
