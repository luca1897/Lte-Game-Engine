...
int engineMain(unsigned int argc, void *argv )
{
  ...
  device->getFileSystem()->addZipFileArchive("ms0:/media/engine.dat");
	...
	*/
	...
	scene node animators. In this way, collision detection and response in the 
	...
	*/
	...
	/*
	Because collision detection is no big deal in this engine, I'll describe how to
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("ms0:/media/particle.bmp"));
	...
	material.Texture1 = driver->getTexture("ms0:/media/faerie2.bmp");
	material.Lighting = true;

	scene::IAnimatedMeshSceneNode* node = 0;
	scene::IAnimatedMesh* faerie = smgr->getMesh("ms0:/media/faerie.md2");
	...
	*/
	...
	while(device->run())
	{
		...
		*/
		...
		/*
		Another type of picking supported by the Engine is scene node picking
