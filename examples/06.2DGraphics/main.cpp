...
int engineMain(unsigned int argc, void *argv )
{
  ...
  setupPSP(); // setup psp
	...
	engineDevice *device = createDevice(); // create device
...
/*
	...
	we don't tell it the color directly, we just say to get tthe color by
...
*/
	video::ITexture* images = driver->getTexture("ms0:/media/2ddemo.bmp");
...
*/
	...
	gui::IGUIFont* font2 = device->getGUIEnvironment()->getFont("ms0:/media/fonthaettenschweiler.bmp");
