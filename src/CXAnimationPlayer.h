...
virtual void useCMeshBones(core::array<core::matrix4>* lstBones, bool use);
virtual void getBones(core::array<core::matrix4>* lstBones);

private:
bool useCMBones;
core::array<core::matrix4>* CMBones;
struct SWeightData
{
	SWeightData() {
	};
